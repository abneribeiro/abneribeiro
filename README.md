...
- 🌱 Actively learning the intricacies of **Go and C**, enhancing my coding prowess.

- 👯 I invite collaborators for the [EquipReserve ](https://github.com/abneribeiro/EquipReserve) project. Join the coding adventure!
---

<details>
 <summary><h3>👨🏽‍💻 Abner's Coding Journey</h3></summary>
   Since my early teens, I've passionately explored the intersection of music and technology. Starting with Java at 14, I quickly transitioned to JavaScript, sparking my journey into web development. Mastering HTML, CSS, and JavaScript, I created interactive websites, driving my curiosity further. Venturing into frontend development, I embraced frameworks like React.js and Vue.js, excelling in crafting dynamic user interfaces. Continuously enhancing skills in responsive design and web performance optimization, I thrive on challenges and milestones, driven to evolve as a frontend developer. Eager to explore new horizons and contribute to the dynamic world of web development.
